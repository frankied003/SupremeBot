...
var FuzzySet = function (arr, useLevenshtein, gramSizeLower, gramSizeUpper) {
    ...
    var _iterateGrams = function(value, gramSize) {
        ...
        for (var index = 0; index < simplified.length - gramSize + 1; ++index) {
            results.push(simplified.slice(index, index + gramSize));
        }
        return results;
    };
    ...
    fuzzyset.__get = function(value, gramSize) {
        ...
        if (this.useLevenshtein) {
            ...
            for (i = 0; i < endIndex; ++i) {
                levenshteinResults.push([_distance(results[i][1], normalizedValue), results[i][1]]);
            }
